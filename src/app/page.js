          ...
          <div className="space-y-12 min-w-0">
            ...
            <section>
              <div className="bg-card p-5 rounded-lg border border-gray-800 shadow-xl relative overflow-hidden">
                ...
                <SectionHeader title="MANHUA UPDATE" icon={Palette} link="/type/manhua" color="border-pink-500" />
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                  {manhuas?.slice(0, 12).map((manga) => (
                    <MangaCard key={manga._id} manga={manga} />
                  ))}
                </div>
              </div>
            ...
            <section>
              <div className="bg-card p-5 rounded-lg border border-gray-800 shadow-xl relative overflow-hidden">
                ...
                <SectionHeader title="MANGA UPDATE" icon={BookOpen} link="/type/manga" color="border-blue-500" />
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">

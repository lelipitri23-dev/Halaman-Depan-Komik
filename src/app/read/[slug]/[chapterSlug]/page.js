...
export async function generateMetadata({ params }) {
  ...
  const pageTitle = `Baca ${chapter.title} Bahasa Indonesia`;
  const pageDesc = `Baca ${chapter.title} bahasa Indonesia terbaru dengan kualitas tinggi di ${SITE_CONFIG.name}.`;

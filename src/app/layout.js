...
export const metadata = {
  ...
  // ✅ FIX 1: Definisikan manifest di sini, jangan pakai tag <link> manual
...
export default function RootLayout({ children }) {
  return (
    <html lang="id">
      {/* ✅ FIX 2: Hapus tag <head> manual. Next.js akan membuatnya otomatis berdasarkan 'metadata' di atas */}
      <body className={`${inter.className} bg-dark text-white flex flex-col min-h-screen`}>
        
        {/* ✅ FIX 3: Letakkan semua <Script> di dalam <body> */}
        <Script
          id="ads-script"

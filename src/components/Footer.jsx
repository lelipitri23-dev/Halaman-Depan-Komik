        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
            ...
            <div className="space-y-4">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                    {SITE_CONFIG.name} - Platform baca komik online terlengkap di Indonesia. Baca ribuan komik manga, manhwa, dan manhua gratis dengan kualitas terbaik. Temukan komik favoritmu dan nikmati pengalaman membaca yang menyenangkan di {SITE_CONFIG.name}!
                </p>
            </div>

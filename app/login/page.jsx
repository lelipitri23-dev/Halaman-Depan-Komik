        ...
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-8">
            <Link href="/" className="inline-flex items-center gap-1">
              <span className="font-display text-3xl text-accent-red tracking-widest">KOMIK</span>
              <span className="font-display text-3xl text-text-primary tracking-widest">VERSE</span>
            </Link>

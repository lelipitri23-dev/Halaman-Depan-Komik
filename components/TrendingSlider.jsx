      ...
      <div className="absolute inset-0">
        {item?.coverImage && (
          <Image
            ...
            alt=""
            fill
            className="object-cover blur-x scale-110 opacity-30"
            unoptimized
            priority
          />
        )}
        ...
        <div className="flex gap-4 items-end w-full">
          ...
          <div className="flex-1 min-w-0 mb-1">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-xs font-bold text-accent-red uppercase tracking-widest font-display">🔥 Trending #{current + 1}</span>
            </div>
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              {item?.rating > 0 && (
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-xs font-bold text-accent-gold">{item.rating?.toFixed(1)}</span>
                </div>
              )}
            </div>
          </div>
